...
//
//public class EntityFragmentOld extends MvpBaseFragment<ProductsPresenter> implements ProductsContract.View {
...
//    List<Object> items;
//
//    public static EntityFragmentOld getInstance(String title) {
//        EntityFragmentOld sf = new EntityFragmentOld();
//        return sf;
//    }
//
//    @Override
