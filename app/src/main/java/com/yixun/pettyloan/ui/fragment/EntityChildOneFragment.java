...
public class EntityChildOneFragment extends MvpBaseFragment<ProductsPresenter> implements ProductsContract.View {
    ...
    public static EntityChildOneFragment getInstance(String title) {
        EntityChildOneFragment sf = new EntityChildOneFragment();
        sf.mTitle = title;
        return sf;
    }
    ...
    protected void initData() {
        ...
        requestMap.put(ProductsListBean.PRO_CATEGORY_ID, 1);
