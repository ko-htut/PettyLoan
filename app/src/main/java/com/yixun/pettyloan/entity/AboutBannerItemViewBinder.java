 ...
 */
public class AboutBannerItemViewBinder extends ItemViewBinder<BannerFeed, AboutBannerItemViewBinder.ViewHolder> {

    @NonNull
    @Override
    protected ViewHolder onCreateViewHolder(
            @NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        View view = inflater.inflate(R.layout.item_about_feed_banner, parent, false);
